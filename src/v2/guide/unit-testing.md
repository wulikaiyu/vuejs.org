...
关于 Vue 单元测试的更多深入信息，请查看 [vue-test-utils](https://vue-test-utils.vuejs.org/) 和我们的 Cookbook 中 [单元测试 vue 组件](https://vuejs.org/v2/cookbook/unit-testing-vue-components.html) 部分。
